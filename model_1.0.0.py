...
_, img_width,img_height,__=np.shape(img)
...
x_train, x_valid, y_train, y_valid = train_test_split(img,y,test_size=0.20, random_state=42)

batch_size = 16
train_dataset = tf.data.Dataset.from_tensor_slices((img, y))
